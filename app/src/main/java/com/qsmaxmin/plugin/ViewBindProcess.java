...
class ViewBindProcess {
    ...
    void process(RoundEnvironment roundEnv) {
        ...
        String docStr = "auto generated by QsPlugin on " + timeStr +
                "\nMake sure that the plug-in(QsPlugin) version is consistent with the QsBase framework version, otherwise unpredictable errors may occur!\n";
